...
single = Label(root, text = "Scoreboard", font="none 14 bold").place(x = 95,y = 0)

name = Label(root, text = "Player 1", font="none 8 bold").place(x = 30,y = 50)  
name1 = Label(root, text = "Player 2", font="none 8 bold").place(x = 30, y = 90)
...
L = Label(root, text = root.score)
L.place(x = 30, y = 140)
K = Label(root, text = root.score2)
K.place(x = 130, y = 140)
J = Label(root, text = root.score3)
J.place(x = 230, y = 140)

player1_entry = Entry(root, textvariable = player1, width = "20").place(x = 80, y = 50)
player2_entry = Entry(root, textvariable = player2, width = "20").place(x = 80, y = 90)


btn1 = Button(root, text="Save", command=save_info).place(x = 230, y = 90)   
